...
const TRASH_POKEMON: { category: string; pokemon: { no: number; name: string; en: string }[] }[] = [
  {
    ...
    pokemon: [
      ...
      { no: 161, name: '꼬리선', en: 'Sentret' }, { no: 162, name: '다고리', en: 'Furret' },
      ...
      { no: 399, name: '비버니', en: 'Bidoof' }, { no: 400, name: '비버통', en: 'Bibarel' },
      { no: 424, name: '겟핸보숭', en: 'Ambipom' },
      { no: 431, name: '나옹마', en: 'Glameow' }, { no: 432, name: '몬냥이', en: 'Purugly' },
      ...
      { no: 731, name: '콩코구리', en: 'Pikipek' }, { no: 732, name: '크라파', en: 'Trumbeak' },
      { no: 819, name: '탐리스', en: 'Skwovet' }, { no: 820, name: '요씽리스', en: 'Greedent' },
    ],
  },
  {
    category: '벌레 잡몬',
    pokemon: [
      ...
      { no: 401, name: '귀뚤뚜기', en: 'Kricketot' }, { no: 402, name: '귀뚤토크', en: 'Kricketune' },
  ...
  },
  {
    ...
    pokemon: [
      ...
      { no: 546, name: '소미안', en: 'Cottonee' }, { no: 547, name: '엘풍', en: 'Whimsicott' },
  ...
  },
  {
    ...
    pokemon: [
      ...
      // 델빌 제외 (메가 헬가)
      { no: 261, name: '포차나', en: 'Poochyena' }, { no: 262, name: '그라에나', en: 'Mightyena' },
      ...
      { no: 316, name: '꼴깍몬', en: 'Gulpin' }, { no: 317, name: '꿀꺽몬', en: 'Swalot' },
